        ...
        btnBookNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    String api_url = "https://nearcabs.pylanconsultancy.co.ke/api/book_cab.php";
    ...
    public Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                String api_url = "https://nearcabs.pylanconsultancy.co.ke/api/get_cab_location.php";
...
//                markerOptions.rotation(location.getBearing());
    ...
    public void setNearbyCabsOnMap(LatLng latLng) {
        try {
            String api_url = "https://nearcabs.pylanconsultancy.co.ke/api/get_near_cabs.php";
...
//            Log.d("Exception while downloading url", e.toString());
     ...
     * we just add a marker near Nairobi, Kenya.
